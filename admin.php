...
<html lang = "eng">
	<head>
		<title>Pengabsenan Jemaat ko james</title>
		<meta charset = "utf-8" />
		...
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					<img src = "html/images/logo.png" width = "200px" height = "50px"/>
					<p class = "navbar-text pull-right">Pengabsenan Jemaat</p>
				</div>
			...
			<ul class = "nav nav-pills">
				...
				<li class = "dropdown active">
					...
					<ul class = "dropdown-menu">
						...
						<li><a href = "student.php"><span class = "glyphicon glyphicon-user"></span> Jemaat</a></li>
					</ul>
				</li>
				...
				<table id = "table" class = "table table-bordered">
					...
					?>
						<tr>
							...
							<td><?php echo md5($f_admin['last_login'])?></td>
							<td><?php echo $f_admin['is_locked_out']?></td>
